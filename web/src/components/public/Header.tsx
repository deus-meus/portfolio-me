    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-brand-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-16 py-2.5 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-0 shrink-0">
          <a href="#" className="flex flex-col min-w-0 py-0.5 space-y-1">
            <span className="font-bold text-sm sm:text-base md:text-lg text-brand-900 tracking-tight leading-tight">
              {fullName}
            </span>
            <div className="flex items-center">
              <span className="px-1.5 py-0.5 text-[9px] sm:text-[10px] font-mono font-semibold tracking-wider uppercase bg-brand-100 text-brand-800 border border-brand-200 leading-none">
                {roleTitle}
              </span>
            </div>
            <span className="text-[11px] font-mono text-brand-500 hidden xl:block leading-tight">
