        ...
        <div className="lg:col-span-7 flex flex-col space-y-5">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2 sm:gap-2.5 pt-1 w-full">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-brand-900 text-white text-xs font-semibold hover:bg-brand-800 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-1.5 px-3 sm:px-3.5 py-2 sm:py-2.5 bg-white text-brand-800 border border-brand-300 text-xs font-semibold hover:bg-brand-50 hover:border-brand-400 transition-colors"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 px-3 sm:px-3.5 py-2 sm:py-2.5 bg-white text-brand-800 border border-brand-300 text-xs font-semibold hover:bg-brand-50 hover:border-brand-400 transition-colors col-span-2 sm:col-span-1"
            >
              <Mail className="w-4 h-4 text-emerald-600 shrink-0" />
              <span className="truncate max-w-[220px] xs:max-w-none">{profile?.email || "dwinarwastu02@gmail.com"}</span>
            </a>
          </div>
