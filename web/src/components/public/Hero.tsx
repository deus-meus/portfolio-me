        ...
        <div className="lg:col-span-7 flex flex-col space-y-5">
          ...
          <div className="flex flex-wrap items-center gap-2.5 pt-1">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 bg-brand-900 text-white text-xs font-semibold hover:bg-brand-800 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-3.5 py-2.5 bg-white text-brand-800 border border-brand-300 text-xs font-semibold hover:bg-brand-50 hover:border-brand-400 transition-colors"
            >
          ...
          <div className="pt-4 border-t border-brand-200 grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono text-xs">
            <div className="p-3.5 bg-white border border-brand-200 hover:border-emerald-200 transition-colors">
              <div className="flex items-center justify-between mb-1">
                <span className="text-brand-500 uppercase text-[10px] font-semibold tracking-wider">Experience</span>
