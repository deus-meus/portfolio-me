...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white border-t border-brand-200 mt-20" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-8 border-b border-brand-200">
          ...
          <div className="flex items-center gap-4 text-xs font-mono">
            <span className="inline-flex items-center gap-1.5 text-emerald-700 bg-emerald-50 px-2.5 py-1 border border-emerald-200 font-semibold">
              <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
              API Online: 99.95% SLA
            </span>
            <button
              onClick={scrollToTop}
              className="inline-flex items-center gap-1 text-brand-600 hover:text-brand-900 transition-colors border border-brand-200 px-2.5 py-1"
            >
